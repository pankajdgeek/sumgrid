#!/usr/bin/env pwsh
#
# detect-infrastructure-needs.ps1 - PowerShell wrapper for detect-infrastructure-needs.sh
#
...
$bashScript = Join-Path $PSScriptRoot "..\bash\detect-infrastructure-needs.sh"
